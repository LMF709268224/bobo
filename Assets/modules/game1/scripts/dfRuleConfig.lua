...
DFRuleConfig.RuleData =
{
	...
	[3] = [[
		基本术语
		坐园子：麻将开始前，约定好一个分值，当有人输到这个分值后，就叫进园子，进园子的人依然可以继续牌局，进园子的人在一些影响输分的操作中将不再出分，但赢分依然会继续往上加。4人局2人进园子，则牌局立即结束弹出大结算，无论进行到第几局。2人/3人局1人进园子，则牌局立即结束弹出大结算，无论进行到第几局。
		风圈：从庄家开始逆时针，轮庄，首次定庄后，依次从东风→南风→西风→北风开始，东风为花牌。如果首次庄家连庄则下局依然为东风为花牌，庄家下庄下家为庄，也是东风为花牌，轮庄满4人后，则庄的花牌从南风开始，依次类推。
		包牌：包牌为一种行牌行为产生的相互关系，行成包牌关系后，在输赢结算上会有所不同，在大丰麻将里为常见现象，算分为适合当地的算分模式。吃/碰一起4次，针对上家，则与上家行成包牌关系。吃/碰一起3次，针对上家，需要手牌能与吃/碰出去的牌行成清一色/混一色，也行成包牌关系。纯碰任意一家4次，则与碰的那家产生包牌关系。纯碰任意一家3次，需要手牌能与碰出去的牌行成碰碰胡或清一色/混一色，也行成包牌关系
