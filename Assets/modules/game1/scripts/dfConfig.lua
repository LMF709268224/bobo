...
DFConfig.EFF_DEFINE =
{
	...
	SUB_DRAGCARDEFF = "Effects_tuodong",--拖动牌
    --结算界面
...
{
	HANDCARDFLYLONGTIME = 0.4,--长距离移牌
	HANDCARDFLYSHORTTIME = 0.2,--短距离移牌
	DELAYPLAYDICEANITIME = 2,--延迟播放骰子动画
	DELAYSHOWOVERUITIME = 5,--延迟多久播放结算界面
	SAIZIPLAYTIME = 2,--骰子动画播放多久
	OUTCARDTIPSHOWTIME = 0.7,--出牌展示框显示多久
	FAPAIANIPLAYTIME = 1,--发牌动画播放多久
	CHATQIPAOSHOWTIME = 2,--聊天汽泡显示多久
}
