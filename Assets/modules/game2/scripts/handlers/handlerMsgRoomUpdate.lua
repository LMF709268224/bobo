...
function Handler.onMsg(msgData, room)
    ...
    local msgRoomUpdate = proto.decodeMessage("mahjong.MsgRoomInfo", msgData)
    ...
    local roomStateEnum = proto.mahjong.RoomState
    local playerStateEnum = proto.mahjong.PlayerState
